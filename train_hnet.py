...
for batch_idx, (data, target) in enumerate(synthom_loader):
    ...
    if batch_idx > 0 and batch_idx % 10 == 0:
        ...
        accum_loss = 0.
        avg_accum_overall_loss = accum_overall_loss / 10
        accum_overall_loss = 0.
        print('-----------------------------------------------------')
        print('Batch idx: {}'.format(batch_idx))
        print('Curr avg overall loss: {}'.format(avg_accum_overall_loss))
        print('Curr avg loss: {}'.format(avg_loss_joints))
        print('Curr avg joint loss (per joint): {}'.format(int(avg_loss_joints / 48)))
        print('-----------------------------------------------------')
...
avg_loss_joints = accum_loss / idx_a
accum_loss = 0.
avg_accum_overall_loss = accum_overall_loss / idx_a
accum_overall_loss = 0.
print('-----------------------------------------------------')
print('Batch idx: {}'.format(batch_idx))
print('Curr avg overall loss: {}'.format(avg_accum_overall_loss))
